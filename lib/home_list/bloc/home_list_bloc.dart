...
class HomeListBloc extends HydratedBloc<HomeListEvent, HomeListState> {
  ...
  HomeListBloc() : super(HomeListInitialState()) {
    on<NextPageEvent>(_goToNextPage);

    on<PreviousPageEvent>(_goToPreviousPage);

    on<SearchCharacterEvent>(_searchCharacter);
  ...
  FutureOr<void> _goToNextPage(NextPageEvent event, Emitter<HomeListState> emit) async {
  ...
  FutureOr<void> _goToPreviousPage(PreviousPageEvent event, Emitter<HomeListState> emit) async {
    emit(state.copyWith(isChangingPage: true));
    final int newPage;
  ...
  FutureOr<void> _searchCharacter(SearchCharacterEvent event, Emitter<HomeListState> emit) async {
  ...
  FutureOr<void> _getPeople(GetPeopleEvent event, Emitter<HomeListState> emit) async {
